...
<body>
    ...
    <div class="container-contact100">
        <div class="wrap-contact100">
            <form action="enviar_pasarxproducto.php" method="post" class="contact100-form validate-form">
                <span class="contact100-form-title">
                    Formato de compra
                </span>
                <span class="contact100-form-title" style="font-size:25px">
                    Recoger en Tienda
                </span>
                ...
                <div style="width: 45%; float:left">
                    ...
                    <div class="wrap-input100 validate-input bg1">
                        ...
                        <input type="text" name="precio" id="precio" class="input100" value="$ <?php echo $precio;?>" readonly>
                    </div>
                </div>
                ...
                <div class="wrap-input100 validate-input bg1" data-validate="Por favor ingresa tu nombre">
                    ...
                    <input type="text" name="name" id="name" class="input100" value="Hola">
                </div>
                ...
                <div class="wrap-input100 validate-input bg0 rs1-alert-validate" data-validate="Porfavor ingresa tu mensaje">
                ...
                <div class="wrap-input100 validate-input bg0 rs1-alert-validate" data-validate="Porfavor ingresa tu mensaje">
                    ...
                    <textarea name="especific" class="input100" placeholder="¿Llegarás un día en espeficio por el producto? Añade lo que necesites que sepamos aquí. (Recuerda reservar el pedido con tiempo)" id="especific"></textarea>
                </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="col-xs-6 col-md-6">
                        ...
                        <p>
                            Numero de Tarjeta: 4152 3137 2725 9983 <br> Numero de Cuenta: 289 596 209 9 <br> Beneficiario: Gregorio Gonzales Mancilla<br> <b>Monto:</b> $<?php echo $precio; ?>
                        </p>
                    </div>
                    ...
                    <div class="col-xs-6 col-md-6">
                        ...
                        <p>
                            Inbursa: 465 828 501 135 501 7<br> Beneficiario: Gregorio Gonzales Mancilla<br> <b>Monto:</b> $<?php echo $precio; ?>
                        </p>
                    </div>
                    ...
                    <div class="col-xs-12">
                        <br>
                        <div>
                            Una vez realizado su pago por favor envíenos una fotografía de su ticket al correo "regalosgregory2009@hotmail.com" nosotros nos contactaremos con usted por correo electrónico para confirmar su pedido.
