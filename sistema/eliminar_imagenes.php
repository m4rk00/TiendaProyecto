<?php 
	...
	if(!empty($_POST))
	{
		...
		$query_delete = mysqli_query($conection,"DELETE FROM imagen_card WHERE id =$id ");
	...
	<section id="container">
		<div class="data_delete">
			...
			<form method="post" action="">
				<br><br>
				<h2>¿Está seguro de eliminar la siguiente imagen?</h2>
				<p>Nombre: <span><?php echo $descripcion; ?></span></p>
				<input type="hidden" name="id" value="<?php echo $id; ?>">
				<a href="lista_imagenes.php" class="btn_cancel">Cancelar</a>
