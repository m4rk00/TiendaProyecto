...
$message = "Este pedido fue enviado por: " . $name . " \r\n";
...
$message2 = "Recibimos tu siguiente pedido:\r\n";
$message2 .= "Articulo solicitado: " . $producto . " \r\n";
$message2 .= "Direccion de recuperacion: " . $mensaje . " \r\n";
...
$asunto = 'Pedido para recoger en tienda:';
